...
@WebServlet("/rcdupdate") 
public class RcdUpdateController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		System.out.println("In RcdUpdateController");
		...
		if(isMultipart == true){
			...
			System.out.println("RcdUpdateController 1");
			...
			System.out.println("RcdUpdateController 2");
			...
			System.out.println("RcdUpdateController 3");

			Iterator<FileItem> it = items.iterator();
			System.out.println("RcdUpdateController 4");
			...
			RescuedDogDto dto = new RescuedDogDto(title, myContent, fileName, newfileName);
			boolean isS = dao.updateRescued(dto, seq);

			if(isS)
				System.out.println("updateRescued Success!!");
