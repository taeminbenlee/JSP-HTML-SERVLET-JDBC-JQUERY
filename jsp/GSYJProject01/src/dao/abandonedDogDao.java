...
public class abandonedDogDao {
	...
	public List<Dto.abandonedDogDto> getAbandonedDogPagingList(String choice, String search, int page){
		
		String sql = " SELECT SEQ, MYID, PHONENUM, ADDRESS, MYCONTENT, FILENAME, NEWFILENAME, DANGER, WDATE, DEL "
				+ " FROM ABANDONEDDOG ";
	...
	public boolean writeReport(abandonedDogDto dto) {
		String sql = " INSERT INTO ABANDONEDDOG "
				+ " (SEQ, MYID, PHONENUM, ADDRESS, MYCONTENT, FILENAME, NEWFILENAME, DANGER, WDATE, DEL) "
				+ " VALUES( SEQ_ABANDONEDDOG.NEXTVAL, ?, ?, ?, ?, ?, ?, ?, SYSDATE, 0 ) ";
