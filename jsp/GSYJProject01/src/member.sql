...
FILENAME VARCHAR2(200) PRIMARY KEY, --동물이미지
NEWFILENAME VARCHAR2(200) NOT NULL, --이미지
DANGER NUMBER NOT NULL,                --위험 정도(1-3)
WDATE DATE NOT NULL,                 --등록일
DEL NUMBER(1) NOT NULL 				--삭제용
);
...
SELECT * FROM MYMEMBER;
SELECT * FROM ABANDONEDDOG;
SELECT SEQ, MYID, PHONENUM, ADDRESS, MYCONTENT, FILENAME, NEWFILENAME, DANGER, WDATE
				FROM ABANDONEDDOG
				WHERE SEQ=3;
				
				
UPDATE ABANDONEDDOG
SET MYID='taemin', PHONENUM=0102003000, ADDRESS='서울역', MYCONTENT='노숙견', FILENAME='제버ㅗ.jpg', NEWFILENAME='123123', DANGER=4, WDATE=SYSDATE
WHERE SEQ=3;